...
//  AFBrightness
//
//  Created by yzl on 2017/5/19.
//  Copyright © 2017年 yzl. All rights reserved.
//  亮度调整

#import "AFBrightness.h"

#define SCREEN_W ([UIScreen mainScreen].bounds.size.width)
#define SCREEN_H ([UIScreen mainScreen].bounds.size.height)
@interface AFBrightness()
...
@end
@implementation AFBrightness

+ (instancetype)brightness{
    
    static AFBrightness *instance = nil;
    ...
    if (instance == nil) {
        ...
        dispatch_once(&onceToken, ^{
            ...
            instance = [[AFBrightness alloc] init];
        });
    }
    [[[UIApplication sharedApplication].windows lastObject] addSubview:instance];
    return instance;
}
...
- (instancetype)init {
    ...
    if (self = [super init]) {
        ...
        //        self.centerX = SCREEN_W*0.5;
        //        self.centerY = SCREEN_H*0.5;
        //        self.size = CGSizeMake(155, 155);
        ...
        self.title = ({
            ...
            title.textColor = [UIColor colorWithRed:0.25f green:0.22f blue:0.21f alpha:0.90f];
